...
Always use the CSS variables import from @companycam/slab-tokens to add color. The "light-environment" and "dark-environment" CSS classes allow you to switch between light and dark UIs.

Always use the https://cdn.jsdelivr.net/npm/@mdi/font@7.1.96/css/materialdesignicons.min.css import for icons. For example: <i className="mdi mdi-pencil" />.
